          ...
          child: ListView(
            children: <Widget>[
              GuideContainer(
                guideNo: 1,
                title: "Add Contacts",
                imagePath: 'phonebook2.png',
                guideDescription:
                "Press 'PhoneBook' Button to add emergency contact. You can edit, update and delete contact.",
              ),
              GuideContainer(
                title: "Edit Contacts",
                guideNo: 2,
                imagePath: 'edit.png',
                guideDescription:
                "Tap any 'Contact' in the  list at your contact screen to remove / edit it from the list. Don't worry it will not be removed from your phone book.",
              ),
              GuideContainer(
                guideNo: 3,
